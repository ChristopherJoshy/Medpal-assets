...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF6A5ACD);
  late Color secondary = const Color(0xFF000000);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFF8A2BE2);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF333333);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF5F5F5);
  late Color accent1 = const Color(0xFF4B0082);
  late Color accent2 = const Color(0xFF483D8B);
  late Color accent3 = const Color(0xFF9370DB);
  late Color accent4 = const Color(0xFF7B68EE);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0xFF3A006A);
  late Color accent2 = const Color(0xFF342F6E);
  late Color accent3 = const Color(0xFF7A5DC3);
  late Color accent4 = const Color(0xFF5F54D6);
  late Color success = const Color(0xFF2AA52A);
  late Color warning = const Color(0xFFE5C600);
  late Color error = const Color(0xFFD60000);
  late Color info = const Color(0xFF1477C4);
}
