...
class _CreatetaskWidgetState extends State<CreatetaskWidget> {
  ...
  void initState() {
    ...
    _model.taskdiscripTextController ??=
        TextEditingController(text: widget.details);
    _model.taskdiscripFocusNode ??= FocusNode();
  }
          ...
          Flexible(
            child: Align(
              ...
              child: SizedBox(
                width: MediaQuery.sizeOf(context).width * 1.0,
                child: TextFormField(
                  controller: _model.taskdiscripTextController,
                  focusNode: _model.taskdiscripFocusNode,
                  autofocus: false,
                  obscureText: false,
                  decoration: InputDecoration(
                    isDense: true,
                  ...
                  cursorColor: FlutterFlowTheme.of(context).primaryText,
                  validator: _model.taskdiscripTextControllerValidator
                      .asValidator(context),
                ),
              ),
            ),
